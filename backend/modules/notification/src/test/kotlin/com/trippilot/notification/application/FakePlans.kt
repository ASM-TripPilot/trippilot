 ...
 */
class FakePlans(private val placesByDate: Map<LocalDate, List<PlannedPlaceView>> = emptyMap()) : ItineraryPlanFacade {
    override fun findPlanSlots(accountId: UUID, tripId: UUID): List<PlannedSlotView> = emptyList()
    override fun findPlannedPlaces(accountId: UUID, tripId: UUID): Map<LocalDate, List<PlannedPlaceView>> = placesByDate
}
