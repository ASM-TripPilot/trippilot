...
class ArchitectureRulesTest {
    ...
    fun `R1 모듈 간 상호작용은 api 로만 (내부 직접참조 금지)`() {
        slices().matching("com.trippilot.(auth|profile|moderation|accommodationsearch|savedaccommodation|trip|placedata|itinerarygeneration|changelog|recalculation|planbdetection|weathercontext)..")
