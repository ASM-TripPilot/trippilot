...
> v1의 겹침 실태: place_scout 4곳 공유·assembly.validate 4곳 공유 등 → 본 개정으로 **겹침 0**.
...
| **Assembly** | 계산·확정 (C2). 도구가 아니라 **공통 관문** | 1 |
