...
- `agent-hierarchy-design.md` — **2계층 세분화** (정보 에이전트 5종: PlaceScout/Weather/Transit/Persona/Event, Tool 재배치)
...
2026-07-16에 `agent-hierarchy-design.md`가 이를 **대체가 아닌 확장**으로 2계층화함 — 업무 4종은 유지, 정보 계층 5종 신설.
이 두 파일이 components.md·services.md의 에이전트 관련 내용을 대체합니다.
