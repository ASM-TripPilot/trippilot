...
- `agent-structure-v2.md` — **최신 정본: 4상자 파이프라인** (Orchestrator/Provider 5종/Agent 4종/Solver 관문 — 도구 겹침 0)
...
2026-07-16에 `agent-hierarchy-design.md`가 2계층화, **2026-08-02에 `agent-structure-v2.md`가 도구 배타 원칙(멘토 피드백)으로 재개정** — 정보 에이전트→Provider 개명, Solver 공통 관문화.
