...
- `application-design/` — 컴포넌트·메서드·서비스 계층 + **에이전트 구조**(정본: `agent-structure-v2.md`)
...
4. `application-design/agent-structure-v2.md` — 에이전트 구조 최신 정본 (2026-08-02 도구 배타 원칙 개정). `agent-redesign.md`·`agent-hierarchy-design.md` 는 그 앞 판이며 이력으로 남긴다
