...
- `application-design/` — component · method · service layers + **agent redesign** (mentor feedback)
...
4. `application-design/agent-redesign.md` — latest agent structure (mentor feedback incorporated)
