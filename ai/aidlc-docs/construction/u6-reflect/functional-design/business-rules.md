...
| # | 내용 | 해소 시점 |
|---|---|---|
| ~~미결 #1~~ | **(c′) 1차 미전달로 확정** (2026-08-25 — FE 비차단 방침, 협상 항목 최소화. vision 캡션만 적용, binding_hints는 BE 수요 발생 시 재론) | ~~BE 협의~~ 해소 |
...
| 미결 #4 | **잠정 채택: 캡션 40자(remote config)·장면 3~8** (2026-08-25 — FE 비차단 방침으로 선행, FE 렌더러 의견 시 값만 조정) | FE 통합 시 조정 |
