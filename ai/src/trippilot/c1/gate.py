    ...
    def apply(
        ...
        *,
        ...
        if pool is None:
            ...
            return GateOutcome(scored=(), drop_event=None, error="gate_error: 후보 풀 없음")
        try:
            raws = _parse_scores(raw_text)
        except ValueError as e:
            return GateOutcome(scored=(), drop_event=None, error=f"parse_error: {e}")
        ...
        return GateOutcome(scored=tuple(survivors), drop_event=drop_event, error=None)
