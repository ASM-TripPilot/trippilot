...
class PlanBRagConfig:
    ...
    # 1차보다 빠른 모델은 없었다 — sol 5.0 · terra 5.2 · opus 7.6(편차 1.2). 25초
    # 예산에서 8.75초이고, 재시도 모델 선택은 여유 대 벤더 독립의 문제다
    # (`C1Config.retry_models` 주석). 현행 `gpt-5.6-terra` 기준 여유 3.5초.
    # 재시도까지 실패하면 규칙 랭킹이 받으니 손해는 대기 시간뿐이다.
