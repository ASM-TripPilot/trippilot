...
| 작업 | 어디 | 사람 검토 |
|---|---|---|
| **안 그리기**(대안·신규 화면·수정본) | **정본 밴드 행 끝**(그 밴드의 실측 간격 470/450으로 이어 붙임, `figma-traps`) — 별도 검토 밴드는 사용자가 요청할 때만(라이브 max y + 600 아래, 원점 −47) | 그린 뒤 — 사용자가 고르면 옛 프레임을 지우고 자리를 넘긴다(`[보관]` 없음) |
