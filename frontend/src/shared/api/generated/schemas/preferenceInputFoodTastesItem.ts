...
export type PreferenceInputFoodTastesItem =
  (typeof PreferenceInputFoodTastesItem)[keyof typeof PreferenceInputFoodTastesItem];

export const PreferenceInputFoodTastesItem = {
  한식: '한식',
  양식: '양식',
  일식: '일식',
  중식: '중식',
