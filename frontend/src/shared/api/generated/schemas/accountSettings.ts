...
export interface AccountSettings {
  /** true 면 외부 이동 시 제휴 안내를 띄우지 않는다(BR-U6-33). **계정 단위**라 기기가 달라도 같은 값이다 — 설정에 있는 값이 기기마다 다르면 사용자 모델이 깨진다(DEC-U6-7a). `l05` 의 `외부 이동 시 제휴 안내 다시 보기` 토글로 되돌린다. */
  affiliateNoticeDismissed: boolean;
}
