...
export type TripSummaryStatsDistanceSource =
  (typeof TripSummaryStatsDistanceSource)[keyof typeof TripSummaryStatsDistanceSource];

export const TripSummaryStatsDistanceSource = {
  ROUTE: 'ROUTE',
