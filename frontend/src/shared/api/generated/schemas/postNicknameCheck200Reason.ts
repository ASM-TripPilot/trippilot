...
export type PostNicknameCheck200Reason =
  (typeof PostNicknameCheck200Reason)[keyof typeof PostNicknameCheck200Reason];

export const PostNicknameCheck200Reason = {
  OK: 'OK',
  TOO_SHORT: 'TOO_SHORT',
  TOO_LONG: 'TOO_LONG',
