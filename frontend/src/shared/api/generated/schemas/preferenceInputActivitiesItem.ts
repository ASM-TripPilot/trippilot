...
export type PreferenceInputActivitiesItem =
  (typeof PreferenceInputActivitiesItem)[keyof typeof PreferenceInputActivitiesItem];

export const PreferenceInputActivitiesItem = {
  자연: '자연',
  역사문화: '역사문화',
  테마파크: '테마파크',
  맛집투어: '맛집투어',
