 ...
 */
import type { ItinerarySnapshotDaysItemSlotsItem } from './itinerarySnapshotDaysItemSlotsItem';

export type ItinerarySnapshotDaysItem = {
  date: string;
  slots: ItinerarySnapshotDaysItemSlotsItem[];
};
