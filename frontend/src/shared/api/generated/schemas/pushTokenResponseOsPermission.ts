...
export type PushTokenResponseOsPermission =
  (typeof PushTokenResponseOsPermission)[keyof typeof PushTokenResponseOsPermission];

export const PushTokenResponseOsPermission = {
  GRANTED: 'GRANTED',
  DENIED: 'DENIED',
