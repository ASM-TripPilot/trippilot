...
/**
 * AC-W-07·09·10·16 · SocialLoginContainer — 소셜 로그인 배선 통합테스트.
 *
...
describe('SocialLoginContainer — 상태↔화면 배선 (AC-W-07)', () => {
...
describe('SocialLoginContainer — fake×MSW 결합 전이 (AC-W-09)', () => {
...
describe('SocialLoginContainer — 409 이메일 충돌·재로그인 (AC-W-09 · AC-W-16)', () => {
