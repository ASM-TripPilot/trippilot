...
describe('TermsContainer — 활성 조건은 필수 항목만 (AC A3 · A4)', () => {
...
describe('TermsContainer — 전체 동의 양방향 동기화 (AC A5 · A6)', () => {
...
describe('TermsContainer — 동의 제출 (AC A7 · C4)', () => {
...
describe('TermsContainer — 저장 실패 (AC A8 · INV-4)', () => {
