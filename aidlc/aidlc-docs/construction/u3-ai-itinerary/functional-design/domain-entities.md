...
| **INV-U3-07** | **[2026-09-16 개정] 초안 단계 응답도 슬롯 시각을 렌더한다**(DEC-U3-3) — 원문(2026-08 이전): "초안 단계(h11·h17) 응답에는 고정 블록을 제외한 슬롯의 시각을 렌더하지 않는다 — 데이터는 있어도 표시하지 않는다." 근거: Figma 4221:2448/4224:2448 재설계(TRIP-782/TRIP-783), 화면 정본 우선(TRIP-811 계열), 사용자 확정 2026-09-16 |
